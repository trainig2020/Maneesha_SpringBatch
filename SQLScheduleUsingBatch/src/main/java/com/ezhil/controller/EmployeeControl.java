...
import com.ezhil.config.SQLConfig;
...
public class EmployeeControl {
	...
	public ModelAndView autoScheduling() throws Exception {
		...
		Directory folder = new Directory("C:\\Users\\EZHILARASI\\Documents\\SQLScripts");
		Directory folderCopy = new Directory("C:\\Users\\EZHILARASI\\Documents\\DestSQL");
		try {
	...
	public ModelAndView manualSchedule() throws Exception {
		...
		File folder = new File("C:\\Users\\EZHILARASI\\Documents\\SQLScripts");
	...
	public ModelAndView manualmodeSch(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int i=0;
			try {
				Resource[] resources = resolver.getResources("file:C:/Users/EZHILARASI/Documents/SQLScripts/*.sql" );
